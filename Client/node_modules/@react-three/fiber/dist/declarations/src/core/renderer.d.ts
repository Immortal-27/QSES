...
import { UseBoundStore } from '@react-three/fiber/node_modules/zustand';
...
declare function createRenderer<TCanvas>(_roots: Map<TCanvas, Root>, _getEventPriority?: () => any): {
    reconciler: Reconciler.Reconciler<UseBoundStore<RootState, import("@react-three/fiber/node_modules/zustand").StoreApi<RootState>>, Instance, void, Instance, Instance>;
